...
export const constants = {
  ...
  routes: {
    ...
    dashboard: '/dashboard',
    fixtures: '/fixtures',
    fixturesAdd: '/fixtures/add',
    fixturesEdit: '/fixtures/edit/:id',
    fixturesDetails: '/fixtures/details/:id',
    users: '/users',
    usersDetails: '/users/details/:id',
    leagues: '/leagues',
    leaguesAdd: '/leagues/add',
    leaguesEdit: '/leagues/edit/:id',
    teams: '/teams',
    teamsHistory: '/teams/history/:teamId',
    teamsPlayers: '/teams/:teamId/players',
    predictions: '/predictions',
    predictionsDetails: '/predictions/details/:id',
    leaderboard: '/leaderboard',
    leaderboardDetails: '/leaderboard/details/:id',
    rewards: '/rewards',
    rewardsAdd: '/rewards/add',
    rewardsEdit: '/rewards/edit/:id',
    rewardsDetails: '/rewards/details/:id',
    notifications: '/notifications',
    notificationsCreate: '/notifications/create',
    notificationsEdit: '/notifications/edit/:id',
    notificationsDetails: '/notifications/details/:id',
    content: '/content',
    contentFaqAdd: '/content-updates/faq/add',
    contentFaqEdit: '/content-updates/faq/edit/:id',
    polls: '/polls',
    pollsAdd: '/polls/add',
    pollsEdit: '/polls/edit/:id',
    referrals: '/referrals',
    referralsDetails: '/referrals/details/:id',
    logs: '/logs',
    settings: '/settings',
  },
  // Side Menu Width
